...
FabCam::FabCam(glm::vec3 const &pos, glm::vec3 const &eulerAngles)
	: Camera(pos, eulerAngles) {}

FabCam::~FabCam(void) {}

void FabCam::configGUI(GUI *graphicUI) {
...
void FabCam::drawGUI(GUI *graphicUI) {
...
void FabCam::_displayDialogue(GUI *graphicUI, int *searchWord, int *lastWord,
